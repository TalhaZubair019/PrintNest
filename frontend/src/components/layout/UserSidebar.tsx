...
const UserSidebar = ({
  ...
  return (
    <div className="transition-all duration-300 ease-in-out shrink-0 sticky top-24 h-[calc(100vh-120px)] bg-[#0f172a] rounded-3xl shadow-2xl border border-slate-800 flex-col overflow-hidden scrollbar-hide z-40 w-64 hidden lg:flex">
